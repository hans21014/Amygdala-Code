...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = - 4.0; // y position of the parallel encoder (in inches)
        public double perpXTicks = 4.5; // x position of the perpendicular encoder (in inches)
    }
